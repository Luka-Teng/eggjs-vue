    ...
    div(class="w3-container w3-blue")
      div(class="w3-row")
        ...
        div(class="w3-col s9")
          ul(class="w3-navbar")
            li
              router-link(:to="{name: 'user_signup'}" class="w3-padding-12 w3-hover-text-purple w3-hover-white") signup

    // 显示csrftoken和用户登录信息
    div(class="w3-row w3-margin-top")
      div(class="w3-half")
        div(class="w3-container w3-pale-blue w3-leftbar w3-border-green")
          h3 CSRF TOKEN
